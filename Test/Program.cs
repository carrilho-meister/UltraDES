...
namespace Test
{
    class Program
    {
        static void Main()
        {
            var s =
                Enumerable.Range(0, 6)
                    .Select(
                        i => new
                        {ind = i,
                         st = new State(i.ToString(),
                             i == 0
                                 ? Marking.Marked
                                 : Marking.Unmarked)})
                    .ToDictionary(o => o.ind, o => o.st);
                ...
                Enumerable.Range(0, 100)
                    .Select(
                        i =>
                            ...
                            {
                                ind = i,
                                ev = new Event(i.ToString(),
                                    i%2 != 0
                                        ? Controllability.Controllable
                                        : Controllability.Uncontrollable)
                            })
                    .ToDictionary(o => o.ind, o => o.ev);
            ...
            Console.WriteLine("Milling Model Regular Expression : {0}\n", milling.ToRegularExpression.Simplify);
            ...
            Console.WriteLine(robot.ToDotCode);
